...
### HTTP 为什么不安全
1. 使用明文通讯，数据没有加密，内容可能被窃取
3. 容易被篡改，没有完整性校验
2. 没有身份验证（这里的身份是指服务端身份）


### HTTPS 为什么安全
逐个击破 HTTP 不安全的点，就可以达到安全的目的
#### 
...
使用 HTTPS 的网站，我们的电脑会先和服务器建立一个安全的连接通道，然后服务器会先发送一份网站的证书信息到客户端，客户端在发送信息的时候会携带钥匙，然后服务端再用自己的钥匙进行配对，打开数据
