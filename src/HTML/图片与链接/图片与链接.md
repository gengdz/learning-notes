...
<body>
  ...
  <img
    src="/Users/gengdezhou/Documents/gengdz/learning-notes/images/css/伪类.png"
    alt="伪类"
    width="100"
    height="100"
  />
...
还有一个标签为 image，比较容易混淆，特意说明

- 用途：它不是一个标准的 HTML 标签，而是 SVG (Scalable Vector Graphics) 规范的一部分。它用于在 SVG 图形中嵌入光栅图像。
- 环境：<svg> 元素内部。

结论：在标准的 HTML 网页中，应当始终使用 img 标签
...
```html
<a href="https://www.baidu.com" title="百度官网" target="_blank"
  >新窗口打开百度</a
>
```
