...
> The name of the CLI tool, git, is the command,
> checkout is the subcommand,
> -b or anything starting with a - is the option,
> and any user input like branch is the argument.

- command: git
- subcommand: checkout
- option: -b
- argument: "feat/new-feature"
